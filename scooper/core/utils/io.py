...
def write_dict_to_s3(obj: dict, bucket_name: str, object_key: str) -> None:
...
def date_range_input() -> tuple[datetime, datetime]:
    """CLI input for date range."""

    def _validate_date(date_string: str) -> Optional[datetime]:
        try:
